...
Toc.ncp.AgencesTreePanel = function(config) {
  config = config || {};
  ...
  config.loader = new Ext.tree.TreeLoader({
    ...
    baseParams: {
      module: 'roles',
      action: 'load_agences_tree_compte',
      src : config.src || '',
  ...
  Toc.ncp.AgencesTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.ncp.AgencesTreePanel, Ext.tree.TreePanel, {
