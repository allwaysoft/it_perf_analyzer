...
Toc.ctx.ctxAmplitudeGrid = function(config) {
...
this.onSearch();
  ...
  Toc.ctx.ctxAmplitudeGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.ctx.ctxAmplitudeGrid, Ext.grid.GridPanel, {
