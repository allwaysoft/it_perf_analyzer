...
Toc.deltausers.RolesTreePanel = function(config) {
  config = config || {};
  ...
  Toc.deltausers.RolesTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.deltausers.RolesTreePanel, Ext.tree.TreePanel, {
