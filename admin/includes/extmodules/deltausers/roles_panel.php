...
*/
?>
Toc.deltausers.RolesPanel = function(config) {
  config = config || {};
  
  config.title = 'Profils';
  ...
  Toc.deltausers.RolesPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.deltausers.RolesPanel, Ext.Panel, {
