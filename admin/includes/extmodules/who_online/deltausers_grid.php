...
Toc.who_online.WhoOnlineGrid = function(config) {
  ...
  config.ds = new Ext.data.Store({
    ...
    listeners: {
        ...
        this.lblInfos.setText(store.data.length + ' Utilisateurs en ligne');
      },
      scope : this
    },
    autoLoad: true
  ...
  Toc.who_online.WhoOnlineGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.who_online.WhoOnlineGrid, Ext.grid.GridPanel, {
