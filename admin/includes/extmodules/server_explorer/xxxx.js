Toc.server_explorer.TreePanel = function (config) {
    var that = this;
    ...
    config.root = new Ext.tree.AsyncTreeNode({
        text: config.rootTitle || 'Servers',
        draggable: false,
        icon : 'templates/default/images/icons/16x16/server.png',
        id: '0',
        expanded: true
    });
    ...
    Toc.server_explorer.TreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.server_explorer.TreePanel, Ext.tree.TreePanel, {
