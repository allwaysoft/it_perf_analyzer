...
Toc.jobs.ScheduleMonthdayPanel = function(config) {
  config = config || {};    
  ...
  Toc.jobs.ScheduleMonthdayPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.jobs.ScheduleMonthdayPanel, Ext.Panel, {
