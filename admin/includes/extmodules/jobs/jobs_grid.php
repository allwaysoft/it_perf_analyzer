...
Toc.jobs.jobsGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.jobs.jobsGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.jobs.jobsGrid, Ext.grid.GridPanel, {
