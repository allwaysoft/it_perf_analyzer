...
Toc.jobs.ScheduleMinutesPanel = function(config) {
  config = config || {};    
  ...
  Toc.jobs.ScheduleMinutesPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.jobs.ScheduleMinutesPanel, Ext.Panel, {
