...
Toc.jobs.ScheduleMonthPanel = function(config) {
  config = config || {};    
  ...
  Toc.jobs.ScheduleMonthPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.jobs.ScheduleMonthPanel, Ext.Panel, {
