...
?>
Toc.jobs.ActionPanel = function(config) {
  config = config || {};
  
  config.layout = 'border';
  config.border = false;

  config.pnlCategoriesTree = new Toc.ActionsTreePanel({owner: config.owner, parent: this,showHome : 0,showContentCount : 1,checkPermission : 1,content_type : 'jobs',rootTitle : 'Jobs'});
  ...
  Toc.jobs.ActionPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.jobs.ActionPanel, Ext.Panel, {
