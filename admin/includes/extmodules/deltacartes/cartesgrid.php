...
Toc.cartes.cartesGrid = function(config) {
  ...
  config.cm = new Ext.grid.ColumnModel([
    ...
    { id: 'date_cartes', header: 'Date cartes', dataIndex: 'date_cartes',align: 'center',width:20},
    config.rowActions
  ]);
...
this.onSearch();
  ...
  Toc.cartes.cartesGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.cartes.cartesGrid, Ext.grid.GridPanel, {
