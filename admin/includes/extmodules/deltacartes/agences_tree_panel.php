...
Toc.cartes.AgencesTreePanel = function(config) {
  config = config || {};
  ...
  config.loader = new Ext.tree.TreeLoader({
    ...
    baseParams: {
      module: 'roles',
      action: 'load_agences_tree_carte',
      src : config.src || '',
  ...
  Toc.cartes.AgencesTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.cartes.AgencesTreePanel, Ext.tree.TreePanel, {
