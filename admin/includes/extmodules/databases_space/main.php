<?php
  echo 'Ext.namespace("Toc.databases_space");';
?>

Ext.override(TocDesktop.DatabasesSpaceWindow, {

    createWindow: function () {
        var desktop = this.app.getDesktop();
        var win = desktop.getWindow('databases_space-win');
