...
Toc.reports.ScheduleHoursPanel = function(config) {
  config = config || {};    
  ...
  Toc.reports.ScheduleHoursPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.reports.ScheduleHoursPanel, Ext.Panel, {
