...
Toc.reports.ScheduleRangePanel = function(config) {
  config = config || {};    

  config.deferredRender = false;
  config.items = this.getDataPanel();
    
  Toc.reports.ScheduleRangePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.reports.ScheduleRangePanel, Ext.Panel, {
