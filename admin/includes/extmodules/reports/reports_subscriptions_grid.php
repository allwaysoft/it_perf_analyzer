...
Toc.reports.subscriptionsGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.reports.subscriptionsGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.reports.subscriptionsGrid, Ext.grid.GridPanel, {
  onRefresh: function() {
    this.getStore().reload();
  },

  onAdd: function() {
    var dlg = new Toc.reports.reportScheduleDialog();
  ...
  onSubscribe: function(record) {
    var dlg = new Toc.reports.subscriptionDialog();
