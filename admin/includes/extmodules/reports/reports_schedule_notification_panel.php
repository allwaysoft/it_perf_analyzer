...
Toc.reports.ScheduleNotificationPanel = function(config) {
  config = config || {};    
  ...
  Toc.reports.ScheduleNotificationPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.reports.ScheduleNotificationPanel, Ext.Panel, {
