...
Toc.reports.ScheduleFormatsPanel = function(config) {
  config = config || {};    
  ...
  Toc.reports.ScheduleFormatsPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.reports.ScheduleFormatsPanel, Ext.Panel, {
  getFormat: function() {
    return Ext.getCmp('checkboxgroup_format').items.get(0).getGroupValue();
  },
  getDataPanel: function() {
   this.checkboxgroup = {
            xtype: 'checkboxgroup',
            id:'checkboxgroup_format',
            fieldLabel: '',
