...
Toc.reports.ScheduleWeekdayPanel = function(config) {
  config = config || {};    
  ...
  Toc.reports.ScheduleWeekdayPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.reports.ScheduleWeekdayPanel, Ext.Panel, {
