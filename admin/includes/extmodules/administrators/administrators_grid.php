...
Toc.administrators.AdministratorsGrid = function(config) {
  ...
  Toc.administrators.AdministratorsGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.administrators.AdministratorsGrid, Ext.grid.GridPanel, {

  onAdd: function() {
    var dlg = this.owner.createAdministratorsDialog();
