...
Toc.comptes_oracle.AddSubscriberDialog = function(config) {

  config = config || {};
  
  config.id = 'comptes_oracle_add_subscriber_dialog-win';
  ...
  Toc.comptes_oracle.AddSubscriberDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.comptes_oracle.AddSubscriberDialog, Ext.Window, {
  ...
  show: function (databases_id,event) {
    ...
    Toc.comptes_oracle.AddSubscriberDialog.superclass.show.call(this);
  },
