...
Toc.comptes_oracle.CreateUserDialog = function(config) {

  config = config || {};
  
  config.id = 'comptes_oracle_create_user_dialog-win';
  ...
  Toc.comptes_oracle.CreateUserDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.comptes_oracle.CreateUserDialog, Ext.Window, {
  ...
  show: function (json,caller) {
    ...
    Toc.comptes_oracle.CreateUserDialog.superclass.show.call(this);
  },
  ...
  buildForm: function(config) {
    ...
    this.frmUser = new Ext.form.FormPanel({
      ...
      baseParams: {  
        module: 'users',
        action : 'create_usercomptes_oracle'
      },
