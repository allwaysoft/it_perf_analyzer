...
Toc.comptes_oracle.usersGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.comptes_oracle.usersGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.comptes_oracle.usersGrid, Ext.grid.GridPanel, {
  ...
  onAdd: function() {
    ...
    var dlg = new Toc.comptes_oracle.CreateUserDialog(config);
  ...
  onEdit: function(record) {
    ...
    var dlg = new Toc.comptes_oracle.ResetPwdDialog(config);
