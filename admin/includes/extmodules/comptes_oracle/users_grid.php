<?php
/*
  $Id: comptes_oracleentre_grid.php $
...
Toc.comptes_oracleentre.UsersGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  config.ds = new Ext.data.Store({
    ...
    baseParams: {
      module: 'servers',
      action: 'list_userscomptes_oracleentre'
    },
  ...
  Toc.comptes_oracleentre.UsersGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.comptes_oracleentre.UsersGrid, Ext.grid.GridPanel, {
