...
Toc.comptes_oracleentre.DataPanel = function(config) {
    config = config || {};
    ...
    Toc.comptes_oracleentre.DataPanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.comptes_oracleentre.DataPanel, Ext.Panel, {
    setTyp:function(typ){
