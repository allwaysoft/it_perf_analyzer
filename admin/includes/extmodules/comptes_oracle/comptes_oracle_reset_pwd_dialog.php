...
Toc.comptes_oracle.ResetPwdDialog = function(config) {
  ...
  Toc.comptes_oracle.ResetPwdDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.comptes_oracle.ResetPwdDialog, Ext.Window, {
  ...
  show: function (json,caller) {
    ...
    Toc.comptes_oracle.ResetPwdDialog.superclass.show.call(this);
