...
Toc.comptes_oracle.DatabasesDialog = function(config) {
  ...
  Toc.comptes_oracle.DatabasesDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.comptes_oracle.DatabasesDialog, Ext.Window, {
