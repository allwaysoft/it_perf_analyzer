...
?>
Toc.server_groups.GroupDialog = function(config) {
  config = config || {};
  
  config.id = 'group_dialog-win';
  config.title = 'Configurer un Groupe de serveurs';
  config.width = 800;
  config.height = 350;
  config.modal = true;
  config.iconCls = 'icon-server-win';
  config.layout = 'fit';
  ...
  Toc.server_groups.GroupDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.server_groups.GroupDialog, Ext.Window, {
  ...
  show: function (data) {
    ...
    Toc.server_groups.GroupDialog.superclass.show.call(this);
