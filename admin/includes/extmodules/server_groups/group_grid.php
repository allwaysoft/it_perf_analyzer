...
Toc.server_groups.GroupGrid = function(config) {
  ...
  Toc.server_groups.GroupGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.server_groups.GroupGrid, Ext.grid.GridPanel, {

  onAdd: function() {
    var dlg = new Toc.server_groups.GroupDialog();
