...
Toc.streams.captureGrid = function(config) {
  var that = this;
  config = config || {};
...
Toc.streams.captureGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.streams.captureGrid, Ext.grid.GridPanel, {
