...
Toc.servers.serversGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.servers.serversGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.servers.serversGrid, Ext.grid.GridPanel, {
  
  onAdd: function() {
    var dlg = this.owner.createserversDialog();
