...
Toc.servers.GroupTreePanel = function(config) {
  config = config || {};
  ...
  Toc.servers.GroupTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.servers.GroupTreePanel, Ext.tree.TreePanel, {
