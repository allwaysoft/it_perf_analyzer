...
Toc.databases.DatabasesDialog = function (config) {
    ...
    Toc.databases.DatabasesDialog.superclass.constructor.call(this, config);
};

Ext.extend(Toc.databases.DatabasesDialog, Ext.Window, {
