...
Toc.databases.notificationsGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.databases.notificationsGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.databases.notificationsGrid, Ext.grid.GridPanel, {
