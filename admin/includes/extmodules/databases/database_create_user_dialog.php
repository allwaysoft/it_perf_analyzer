...
Toc.databases.CreateUserDialog = function(config) {
  ...
  Toc.databases.CreateUserDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.databases.CreateUserDialog, Ext.Window, {
  ...
  show: function (json,caller) {
    ...
    Toc.databases.CreateUserDialog.superclass.show.call(this);
  },
