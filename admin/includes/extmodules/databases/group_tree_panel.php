...
Toc.databases.GroupTreePanel = function(config) {
  config = config || {};
  ...
  Toc.databases.GroupTreePanel.superclass.constructor.call(this, config);
};

Ext.extend(Toc.databases.GroupTreePanel, Ext.tree.TreePanel, {
