...
Toc.databases.indexesGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  config.cm = new Ext.grid.ColumnModel([
    ...
    { id: 'segment_name', header: 'Nom', dataIndex: 'segment_name', sortable: true,align: 'center'},
    { id: 'table_name', header: 'Table', dataIndex: 'table_name', sortable: true,align: 'center',width : 70},
    { id: 'tablespace_name', header: 'Tablespace', dataIndex: 'tablespace_name', sortable: true,width : 95,align: 'center'},
    { header: 'Taille (MB)', align: 'center', dataIndex: 'size',sortable: true,width : 60,renderer:Toc.content.ContentManager.FormatNumber},
    ...
    { header: 'Lblocks', dataIndex: 'leaf_blocks', sortable: true,align: 'center',width : 60},
    { header: 'Dkeys', dataIndex: 'distinct_keys', sortable: true,align: 'center',width : 90},
  ...
  Toc.databases.indexesGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.databases.indexesGrid, Ext.grid.GridPanel, {
