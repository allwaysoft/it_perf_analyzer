...
Toc.infoc.ResetPwdDialog = function(config) {
  ...
  Toc.infoc.ResetPwdDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.infoc.ResetPwdDialog, Ext.Window, {
  ...
  show: function (json,caller) {
    ...
    Toc.infoc.ResetPwdDialog.superclass.show.call(this);
