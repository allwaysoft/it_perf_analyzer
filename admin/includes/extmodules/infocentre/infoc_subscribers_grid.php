...
Toc.infoc.notificationsGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.infoc.notificationsGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.infoc.notificationsGrid, Ext.grid.GridPanel, {

  onAdd: function() {
    var dlg = new Toc.infoc.AddSubscriberDialog();
