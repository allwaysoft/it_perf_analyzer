...
Toc.infoc.AddSubscriberDialog = function(config) {

  config = config || {};
  
  config.id = 'infoc_add_subscriber_dialog-win';
  ...
  Toc.infoc.AddSubscriberDialog.superclass.constructor.call(this, config);
}

Ext.extend(Toc.infoc.AddSubscriberDialog, Ext.Window, {
  ...
  show: function (databases_id,event) {
    ...
    Toc.infoc.AddSubscriberDialog.superclass.show.call(this);
  },
