...
Toc.infoc.usersGrid = function(config) {
  var that = this;
  config = config || {};
  ...
  Toc.infoc.usersGrid.superclass.constructor.call(this, config);
};

Ext.extend(Toc.infoc.usersGrid, Ext.grid.GridPanel, {
  ...
  onAdd: function() {
    ...
    var dlg = new Toc.infoc.CreateUserDialog(config);
  ...
  onEdit: function(record) {
    ...
    var dlg = new Toc.infoc.ResetPwdDialog(config);
